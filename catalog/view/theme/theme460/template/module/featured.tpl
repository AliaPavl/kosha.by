			...
			<li class="<?php echo $a. $last_line ;?> col-sm-<?php echo $spanLine ;?>">
						...
						<div class="wrapper marg row">
							...
							<div class="right col-sm-8">
								...
								<div class="product_rating rating">
									<img height="18" src="catalog/view/theme/theme460/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
								</div>
							</div>
						</div>
				...
				<div class="inner">
					<div class="f-left">
						...
						<div class="product_description description"><?php echo mb_substr($product['description1'],0,105,'UTF-8').'...';?></div>
						<?php } ?>
