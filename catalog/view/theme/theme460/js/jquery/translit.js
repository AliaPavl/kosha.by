...
$(document).ready(function(){
	// Products
	setTranslit("product_description\\[4\\]\\[name\\]", "keyword", false);
	// Info Articles
	//setTranslit("information_description\\[4\\]\\[title\\]", "keyword", false);
	// Categories
	//setTranslit("category_description\\[4\\]\\[name\\]", "keyword", false);
	// Manufacturer
